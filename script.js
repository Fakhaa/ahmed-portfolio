...
class ContactForm {
    constructor() {
        ...
        // Paste your Formspree endpoint below (looks like https://formspree.io/f/xxxxxxxx)
        this.endpoint = 'https://formspree.io/f/xwvgkzbq';
        this.init();
    }
    ...
    showSuccess() {
        ...
        if (this.statusEl) {
            this.statusEl.textContent = "Thanks! Your message has been sent.";
